var index = {
  process: function(callback) {
    ...
    Container.model.marque.hasMany(Container.model.modele, {foreignKeyConstraint: false});
    Container.model.modele.belongsTo(Container.model.marque, {foreignKeyConstraint: false});
    //
