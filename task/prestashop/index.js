...
var index = {
  ...
  //
  //     stringify(input, function(err, output){
  //       fs.writeFileSync(__dirname+'/output/marques.csv', output)
  //     });
  //
  //   });
  //
  ...
  //     q.drain = function(){
  //       stringify(input, function(err, output){
  //         fs.writeFileSync(__dirname+'/output/modeles.csv', output)
  //       });
  //     }
  //
  //   });
  ...
  //     q.drain = function(){
  //       stringify(input, function(err, output){
  //         fs.writeFileSync(__dirname+'/output/familles.csv', output)
  //       });
  //     }
  //
  //   });
