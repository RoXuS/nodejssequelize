...
var autoload = function(callback) {
	...
	Container.model.attribut = require(__dirname + '/../model/attribut.js');
	Container.model.attributvaleur = require(__dirname + '/../model/attributvaleur.js');
  ...
  Container.model.attribut.hasMany(Container.model.attributvaleur, {foreignKeyConstraint: true});
  Container.model.attributvaleur.belongsTo(Container.model.attribut, {foreignKeyConstraint: true});
  ...
  Container.model.attributvaleur.hasMany(Container.model.article, {foreignKeyConstraint: true});
  Container.model.article.hasMany(Container.model.attributvaleur, {foreignKeyConstraint: true});
